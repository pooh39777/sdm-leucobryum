...
```{r Compute the AUC from different train/test splits}
...
e_folds <- envBlock(rasterLayer = predictors, speciesData = sp_df, species = "data@pa", k = 5, standardization = "standard", rasterBlock = FALSE, numLimit = 100)
foldExplorer(e_folds, rasterLayer = predictors, speciesData = sp_df)
maxnet_model <- train(method = "Maxnet", data = data, fc = "l", reg = 0.8, folds = e_folds)
...
plotROC(maxnet_model@models[[5]])
plotROC(maxnet_model@models[[1]], test = test)
plotROC(maxnet_model@models[[2]], test = test)
plotROC(maxnet_model@models[[3]], test = test)
plotROC(maxnet_model@models[[4]], test = test)
plotROC(maxnet_model@models[[5]], test = test)
```
...
plotROC(selected_variables_model@models[[1]])
plotROC(selected_variables_model@models[[2]])
plotROC(selected_variables_model@models[[3]])
plotROC(selected_variables_model@models[[4]])
plotROC(selected_variables_model@models[[5]])
plotROC(selected_variables_model@models[[1]], test = test)
plotROC(selected_variables_model@models[[2]], test = test)
plotROC(selected_variables_model@models[[3]], test = test)
plotROC(selected_variables_model@models[[4]], test = test)
plotROC(selected_variables_model@models[[5]], test = test)
```
...
ths <- thresholds(selected_variables_model@models[[1]], type = "cloglog")
ths
