---
title: "SDMs of Leucobryum scalare"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "scalare") %>% 
...
data <- prepareSWD(species = "Leucobryum scalare", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_scalare.csv")
