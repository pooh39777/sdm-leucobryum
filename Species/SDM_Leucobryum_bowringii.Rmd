---
title: "SDMs of Leucobryum bowringii"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "bowringii") %>% 
...
data <- prepareSWD(species = "Leucobryum bowringii", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_bowringii.csv")
...
plotResponse(tuned_model, var = "wc2_17", type = "cloglog", only_presence = TRUE, marginal = TRUE, fun = mean, rug = TRUE)
ggsave("response_curve_wc2_17.png", width = 7, height = 7, units = "cm")
ggsave("response_curve_wc2_17.pdf", width = 7, height = 7, units = "cm")
```
