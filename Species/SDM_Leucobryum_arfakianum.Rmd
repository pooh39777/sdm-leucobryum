---
title: "SDMs of Leucobryum arfakianum"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "arfakianum") %>% 
...
data <- prepareSWD(species = "Leucobryum arfakianum", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_arfakianum.csv")
...
```{r Response curves}
plotResponse(tuned_model, var = "wc2_1", type = "cloglog", only_presence = TRUE, marginal = TRUE, fun = mean, rug = TRUE)
ggsave("response_curve_wc2_1.png", width = 7, height = 7, units = "cm")
ggsave("response_curve_wc2_1.pdf", width = 7, height = 7, units = "cm")
```
