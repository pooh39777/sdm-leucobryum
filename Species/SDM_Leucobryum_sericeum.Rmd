---
title: "SDMs of Leucobryum sericeum"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "sericeum") %>% 
...
data <- prepareSWD(species = "Leucobryum sericeum", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_sericeum.csv")
...
```{r Response curves}
plotResponse(tuned_model, var = "wc2_3", type = "cloglog", only_presence = TRUE, marginal = TRUE, fun = mean, rug = TRUE)
ggsave("response_curve_wc2_3.png", width = 7, height = 7, units = "cm")
ggsave("response_curve_wc2_3.pdf", width = 7, height = 7, units = "cm")
