---
title: "SDMs of Leucobryum humillimum"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "humillimum") %>% 
...
data <- prepareSWD(species = "Leucobryum humillimum", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_humillimum.csv")
