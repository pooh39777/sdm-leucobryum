---
title: "SDMs of Leucobryum sanctum"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "sanctum") %>% 
...
data <- prepareSWD(species = "Leucobryum sanctum", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_sanctum.csv")
...
```{r Response curves}
plotResponse(tuned_model, var = "wc2_2", type = "cloglog", only_presence = TRUE, marginal = TRUE, fun = mean, rug = TRUE)
ggsave("response_curve_wc2_2.png", width = 7, height = 7, units = "cm")
ggsave("response_curve_wc2_2.pdf", width = 7, height = 7, units = "cm")

plotResponse(tuned_model, var = "wc2_11", type = "cloglog", only_presence = TRUE, marginal = TRUE, fun = mean, rug = TRUE)
ggsave("response_curve_wc2_11.png", width = 7, height = 7, units = "cm")
ggsave("response_curve_wc2_11.pdf", width = 7, height = 7, units = "cm")
