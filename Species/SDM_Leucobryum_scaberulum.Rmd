---
title: "SDMs of Leucobryum scaberulum"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "scaberulum") %>% 
...
data <- prepareSWD(species = "Leucobryum scaberulum", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_scaberulum.csv")
