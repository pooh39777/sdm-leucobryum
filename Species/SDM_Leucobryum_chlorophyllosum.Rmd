---
title: "SDMs of Leucobryum chlorophyllosum"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "chlorophyllosum") %>% 
...
data <- prepareSWD(species = "Leucobryum chlorophyllosum", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_chlorophyllosum.csv")
