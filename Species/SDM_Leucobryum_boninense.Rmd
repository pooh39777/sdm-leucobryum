---
title: "SDMs of Leucobryum boninense"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "boninense") %>% 
...
data <- prepareSWD(species = "Leucobryum boninense", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_boninense.csv")
