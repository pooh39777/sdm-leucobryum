---
title: "SDMs of Leucobryum novae-guineae"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "novae-guineae") %>% 
...
data <- prepareSWD(species = "Leucobryum novae-guineae", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_novae-guineae.csv")
...
plotResponse(tuned_model, var = "wc2_10", type = "cloglog", only_presence = TRUE, marginal = TRUE, fun = mean, rug = TRUE)
ggsave("response_curve_wc2_10.png", width = 7, height = 7, units = "cm")
ggsave("response_curve_wc2_10.pdf", width = 7, height = 7, units = "cm")
```
