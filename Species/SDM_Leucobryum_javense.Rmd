---
title: "SDMs of Leucobryum javense"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "javense") %>% 
...
data <- prepareSWD(species = "Leucobryum javense", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_javense.csv")
