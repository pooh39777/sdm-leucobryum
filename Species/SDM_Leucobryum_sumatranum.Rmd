---
title: "SDMs of Leucobryum sumatranum"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "sumatranum") %>% 
...
data <- prepareSWD(species = "Leucobryum sumatranum", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_sumatranum.csv")
