---
title: "SDMs of Leucobryum scabrum"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "scabrum") %>% 
...
data <- prepareSWD(species = "Leucobryum scabrum", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_scabrum.csv")
