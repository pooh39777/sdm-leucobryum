---
title: "SDMs of Leucobryum glaucum"
...
occ.0 <- csv %>% 
  filter(specificEpithet == "glaucum") %>% 
...
data <- prepareSWD(species = "Leucobryum glaucum", p = occ[,2:3], a = bg.point, env = predictors)
...
swd2csv(data, file_name = "data_swd_Leucobryum_glaucum.csv")
...
```{r Response curves}
plotResponse(tuned_model, var = "wc2_14", type = "cloglog", only_presence = TRUE, marginal = TRUE, fun = mean, rug = TRUE)
ggsave("response_curve_wc2_14.png", width = 7, height = 7, units = "cm")
ggsave("response_curve_wc2_14.pdf", width = 7, height = 7, units = "cm")
